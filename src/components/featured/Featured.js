        ...
        <div className='container'>
            ...
            <div className='span-3 img-details'>
                ...
                <div className='info-grid'>
                    ...
                    <div className='info'>
                        <p className='bold'>Estimated Payment:</p><p>$4,797/month</p>
                    </div>
                </div>
            </div>
            <div className='span-2 right-img-details'>
                ...
                <button type='button' className='btn'>View Listing</button>
            </div>
        </div>
        
        {/* Second Section */}
        <div className='contain2er'>
            <img src={Bed3} alt="" />
            <img src={Bed4} alt="" />
